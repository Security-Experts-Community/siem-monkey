...
адресу, содержащемуся в названии поля:
    ...
    * AbuseIPDB
    * VirusTotal
    * В параметрах плагина можно добавить дополнительные сервисы для проверки адресов, указав название, которое должно выводиться в UI,
    а также шаблон ссылки, по которой доступна проверка конкретного адреса (в качестве шаблона для подстановки IP-адреса следует использовать `${ip}`)  
    <img src="https://user-images.githubusercontent.com/51186173/223167512-81787d2c-0dda-4056-8c3f-a806ffcc453c.png" width="400">  
    <img src="https://user-images.githubusercontent.com/51186173/223168640-830317bd-64bb-4048-a281-2fae19561723.png" width="400">  
